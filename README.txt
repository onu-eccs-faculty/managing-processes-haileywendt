[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/sp5e4yyt)
SMP1: Simple Shell
==================
...
In doing so, you will learn the basics of system calls for creating (fork) 
and changing the image (exec) of processes.
...
======================
  ...
  Please make the following modifications to the given file shell.c. Included 
  are some built-in test cases, which are described along with the feature 
  requests below.
  ...
  3. Modify the MP so that it uses waitpid instead of wait.

  4. Create a new builtin command 'sub' that forks the program to create
